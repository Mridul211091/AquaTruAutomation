...
public class AquaTruOrderFlowTest extends BaseTest {
	 ...
	 */
	  ...
	  public void placeOrder(ITestContext
	  testContext,String ModelName,String ThreeYearWarranty,String SlidingTray,String CarafeCombo,String BlueBottle,String BlackBottle,String WhiteBottle, String email, String firstname, String lastname, String addone, String addtwo, String cty ,String
	  state,String zipcode,String phonenumber, String upsellOne,String upsellQuantity, String subtotal, String flatrate, String tax, String finaltotal) throws InterruptedException, Exception
	  {
	  ...
	  Thread.sleep(15000);
	  aquatruPage.selectModel(ModelName,ThreeYearWarranty,SlidingTray,CarafeCombo,BlueBottle,BlackBottle,WhiteBottle); 
	  Thread.sleep(5000);
	  ...
	  aquatruPage.writeexcel(productActDetailsMap.get("subtotal"),productActDetailsMap.get("Shipping"),productActDetailsMap.get("tax"),productActDetailsMap.get("total"),currenttest); 
