...
import agi.qa.aquatru.exceptions.ElementException;
...
public class ElementUtil {
	...
	public void SendKeys(By locator, String value) throws InterruptedException {
		nullBlankCheck(value);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(TimeUtil.DEFAULT_MEDIUM_TIME));
	...
	public void doClickcheckbox(By locator,int timeOut) {
	...
	public void DoSelectValueFromDropDown(By locator, String value) {
		...
		System.out.println("List Size is "+optionsList.size());
	...
	public void printDropDownValue(By locator) {
		List<WebElement> optionsList = getElements(locator);
		for (WebElement e : optionsList) {
			System.out.println("WebElements are" + e);
