...
public class AquaTruAffiliatePage {
	...
	public AquaTruAffiliatePage(WebDriver driver) {
		this.driver = driver;
	...
	public AquaTruAffiliatePage getaffiliateURL(String url) {
		driver.get(url);
		return new AquaTruAffiliatePage(driver);
	}
